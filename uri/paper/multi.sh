...
python gen_sample_info.py --only mitotracker --out live_mito.csv data/live
...
python image_gen.py /scratch/bpho/datasets/movies_002/test tmp/newmito3 --models multit_5_unet_512 --gpu 1
echo "done"
